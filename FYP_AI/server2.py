...
#     def do_GET(self):
#         if self.path == '/CheckAIpose':
#             self.send_response(200)
#             self.send_header('Content-type', 'application/json')
#             self.end_headers()

#             # Simulating API response
#             api_response = {'message': 'Hello from the API!'}
...
#                 # Return a response
#                 api_response = {'message': 'Received the image_data successfully'}
#                 response_json = json.dumps(api_response)
...
result = checkAIPose(image, answer)
print(result)
